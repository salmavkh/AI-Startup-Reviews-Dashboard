...
MODEL_SUBDIR = "distilbert_emotweet28"
TOKENIZER_SUBDIR = "distilbert_emotweet28"
...
def load_model():
    global _tokenizer, _model, _label_names, MODEL_DIR, TOKENIZER_DIR
    if _tokenizer is None or _model is None:
        MODEL_DIR = resolve_artifact_dir(MODEL_SUBDIR)
        TOKENIZER_DIR = resolve_artifact_dir(TOKENIZER_SUBDIR)
